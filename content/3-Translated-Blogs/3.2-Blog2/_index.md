...
*by Varun Jasti, Bryan Rosensteel, and Greg Hewitt | on 26 SEP 2025 | in [Announcements](https://aws.amazon.com/blogs/publicsector/category/post-types/announcements/), [AWS GovCloud (US)](https://aws.amazon.com/blogs/publicsector/category/public-sector/government/aws-govcloud-us/), [Government](https://aws.amazon.com/blogs/publicsector/category/public-sector/government/), [Public Sector](https://aws.amazon.com/blogs/publicsector/category/public-sector/), [Public Sector Partners](https://aws.amazon.com/blogs/publicsector/category/public-sector/public-sector-partners/), [Security & Governance](https://aws.amazon.com/blogs/publicsector/category/business-intelligence/security-governance/)*


Amazon Web Services (AWS) and Wiz are excited to share that [Wiz for Government](https://www.wiz.io/verticals/government) has achieved a [FedRAMP High authorization](https://www.wiz.io/blog/wiz-achieves-fedramp-high-authorization). This milestone reinforces Wiz's commitment to working with AWS and helping U.S. public sector organizations and partners securely manage their environments from code to cloud to runtime.
...
[Wiz](https://partners.amazonaws.com/partners/0010h00001jEHDiAAO/WIz)—an AWS public sector partner and their Cloud Native Application Protection Platform (CNAPP) offering built on [AWS GovCloud (US)](https://aws.amazon.com/govcloud-us/)—is available in the [AWS Marketplace](https://aws.amazon.com/marketplace/seller-profile?id=1ffd8ced-f99a-40f3-9e2c-ee182e2d9861). With the U.S. government-focused offering Wiz for Government, customers—who use the secure infrastructure and services available from AWS, along with Wiz's FedRAMP offering—are better able to meet strict regulatory compliance, including Federal Information Security Modernization Act (FISMA), Federal Risk and Authorization Management Program (FedRAMP), Cybersecurity Maturity Model Certification (CMMC), and International Traffic in Arms Regulations (ITAR) requirements.
...
Government agencies, including the [U.S. Navy's COSMOS program](https://www.wiz.io/customers/niwc-pac-sbs) and the Marine Corps' Operation Stormbreaker, have been utilizing Wiz to help rapidly bring advanced cloud capabilities to their personnel while abiding by strict security regulations. For the Navy COSMOS program, AWS and Wiz are helping to significantly expedite and simplify the secure onboarding of cloud workloads. Together, Wiz and AWS have helped COSMOS to reduce timelines for cloud account onboarding processes from three months to less than 30 minutes.

These impactful results, driven by the combined power of Wiz and AWS, demonstrate a shared commitment to empowering public sector missions with agility and robust security. Take the example of Wiz's integration with [Amazon GuardDuty](https://aws.amazon.com/guardduty/). This integration ingests threat detection alerts from GuardDuty into the Wiz Defend product. These findings are enriched with cloud-context from other findings collected through Wiz to provide a unified, context-rich view, reducing alert fatigue and improving investigation and response times.

### Accelerating the path from Moderate to FedRAMP High through AWS

Wiz's FedRAMP High authorization comes just over a year after Wiz for Government's initial [FedRAMP Moderate designation](https://aws.amazon.com/blogs/apn/securing-your-aws-environment-with-wiz-for-gov-fedramp-authorized/). The uplift from Moderate to High reflects Wiz's continuing dedication to its public sector customers—enabling them to quickly identify, prioritize, and reduce real risk across sensitive environments.
...
You can learn more by visiting the [Wiz for Government webpage](https://www.wiz.io/verticals/government), or explore how Wiz assists other organizations with their government compliance journey on their [FedRAMP solutions page](https://www.wiz.io/lp/wiz-fedramp). Reach out to receive a [live demo](https://www.wiz.io/demo) to see Wiz in action.

To learn more about how Wiz works with AWS, visit the [Wiz and AWS partner page](https://www.wiz.io/partners/aws).

TAGS: [AWS GovCloud (US)](https://aws.amazon.com/blogs/publicsector/tag/aws-govcloud-us/), [AWS Public Sector](https://aws.amazon.com/blogs/publicsector/tag/aws-public-sector/), [AWS Public Sector Partners](https://aws.amazon.com/blogs/publicsector/tag/aws-public-sector-partners/), [fedramp high](https://aws.amazon.com/blogs/publicsector/tag/fedramp-high/), [government](https://aws.amazon.com/blogs/publicsector/tag/government/), [security](https://aws.amazon.com/blogs/publicsector/tag/security/)

![Profile 1](/images/translated-blogs/blog2/pro5-1.png)
Varun Jasti
...
![Profile 2](/images/translated-blogs/blog2/pro5-2.png)
Bryan Rosensteel
...
![Profile 3](/images/translated-blogs/blog2/pro5-3.png)
Greg Hewitt
